...
public class Reivindicacoes {
    ...
    public Reivindicacoes() {}

    public Reivindicacoes(Integer id, String detalhesReivindicacao, Integer itemId, Integer usuarioReivindicadorId, Integer usuarioAchouId, Date dtaCriacao, Boolean flgInativo, Date dtaRemocao) {
        this.id = id;
