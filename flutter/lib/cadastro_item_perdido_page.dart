...
class CadastroItemPerdidoPage extends StatefulWidget {
  ...
  const CadastroItemPerdidoPage({Key? key, this.usuarioLogado})
    : super(key: key);
...
class _CadastroItemPerdidoPageState extends State<CadastroItemPerdidoPage> {
  ...
  Future<void> _cadastrarItem() async {
    ...
    try {
      // TODO: Implementar cadastro do item perdido
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Item perdido cadastrado com sucesso!'),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Erro ao cadastrar item perdido: $e'),
          backgroundColor: Colors.red,
        ),
      );
    }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(
                label: 'Quando você perdeu?',
                controller: _dataController,
              ),
              _buildTextField(
                label: 'Em qual turno você perdeu?',
